...
class _MenuWidgetState extends State<MenuWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    _provider.getShopName(shopData != null ? shopData.data()['shopName'] : '');
    return Container(
      color: Colors.white,
      ...
      child: Column(
        ...
        children: <Widget>[
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: CircleAvatar(
                      radius: 30,
                      backgroundImage: shopData != null
                          ? NetworkImage(shopData.data()['imageUrl'])
                          : null,
                    ),
                  ),
                  SizedBox(
          ...
          sliderItem('Report', Icons.stacked_bar_chart),
