...
import 'package:flutter_vendor_app/widgets/banner_card.dart';
...
class _BannerScreenState extends State<BannerScreen> {
  ...
  Future<String> uploadBannerImage(filePath, shopName) async {
    ...
    try {
      await _storage.ref('shopBanner/$shopName/$timeStamp').putFile(file);
    ...
    String downloadURL =
        await _storage.ref('shopBanner/$shopName/$timeStamp').getDownloadURL();
    return downloadURL;
  }
}
